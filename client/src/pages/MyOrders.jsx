            ...
            {myOrders.map((order, index) => (
                <div key={index} className='border border-gray-300 rounded-lg p-4 py-5 mb-10 max-w-4xl'>
                    ...
                    {order.items.map((item, index) => (
                        ...
                        border-gray-300 flex flex-col justify-between md:flex-row md:items-center p-4 py-5 md:gap-16 w-full max-w-4xl`}>
                            <div className='flex items-center mb-4 md:mb-0'>
                                <div className='bg-primary-/10 p-4 rounded-leg'>
